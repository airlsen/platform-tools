...
export const asyncRouterMap = [

    {
        ...
        hidden:false,
        children: [
            {path: '/home',name: '首页',icon:'thumbsup',component: _import('tools/home/home')},
        ]
    },

    {
        ...
        hidden:false,
        children: [
            {path: '/project',name: '首页',icon:'thumbsup',component: _import('tools/home/home')},
...

    {
        ...
        hidden:false,
        children: [
            {path: '/env',name: '环境管理',icon:'android-list',component: _import('env/Env')},
        ]
    },
